...
enum TEXTURE_FORMAT : int16_t
{
    ...
    /// D3D counterpart: DXGI_FORMAT_R32G32B32A32_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_RGBA32F is used.
    ...
    /// D3D counterpart: DXGI_FORMAT_R32G32B32_TYPELESS. OpenGL does not have direct counterpart, GL_RGB32F is
    /// used. \warning This format has weak hardware support and is not recommended
    ...
    /// D3D counterpart: DXGI_FORMAT_R16G16B16A16_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_RGBA16F is used.
    ...
    /// D3D counterpart: DXGI_FORMAT_R32G32_TYPELESS. OpenGL does not have direct counterpart, GL_RG32F is
    /// used.
    ...
    /// D3D counterpart: DXGI_FORMAT_R32G8X24_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_DEPTH32F_STENCIL8 is used.
    ...
    /// D3D counterpart: DXGI_FORMAT_R32_FLOAT_X8X24_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_DEPTH32F_STENCIL8 is used.
    ...
    /// D3D counterpart: DXGI_FORMAT_R10G10B10A2_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_RGB10_A2 is used.
    ...
    /// green and 10 bits for blue channel. \n D3D counterpart: DXGI_FORMAT_R11G11B10_FLOAT. OpenGL
    /// counterpart: GL_R11F_G11F_B10F.
    TEX_FORMAT_R11G11B10_FLOAT,

    /// Four-component 32-bit typeless format with 8-bit channels. \n
    /// D3D counterpart: DXGI_FORMAT_R8G8B8A8_TYPELESS. OpenGL does not have direct counterpart, GL_RGBA8 is
    /// used.
    ...
    /// D3D counterpart: DXGI_FORMAT_R16G16_TYPELESS. OpenGL does not have direct counterpart, GL_RG16F is
    /// used.
    ...
    /// D3D counterpart: DXGI_FORMAT_R24G8_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_DEPTH24_STENCIL8 is used.
    ...
    /// unreferenced data. \n D3D counterpart: DXGI_FORMAT_R24_UNORM_X8_TYPELESS. OpenGL does not have direct
    ...
    /// D3D counterpart: DXGI_FORMAT_BC1_TYPELESS. OpenGL does not have direct counterpart,
    ...
    /// DXGI_FORMAT_BC1_UNORM. OpenGL counterpart: GL_COMPRESSED_RGB_S3TC_DXT1_EXT.\n
    /// [GL_EXT_texture_compression_s3tc]:
    /// https://www.khronos.org/registry/gles/extensions/EXT/texture_compression_s3tc.txt OpenGL & OpenGLES:
    /// [GL_EXT_texture_compression_s3tc][] extension is required \sa <a href =
    /// "https://msdn.microsoft.com/en-us/library/windows/desktop/bb694531(v=vs.85).aspx#BC1">BC1 on MSDN
    ...
    /// G, 5 bits for B, and 0 or 1 bit for A channel. \n The pixel data is encoded using 8 bytes per 4x4
    /// block (4 bits per pixel) providing 1:8 compression ratio against RGBA8 format. \n D3D counterpart:
    /// DXGI_FORMAT_BC1_UNORM_SRGB. OpenGL counterpart: GL_COMPRESSED_SRGB_S3TC_DXT1_EXT.\n
    /// [GL_EXT_texture_compression_s3tc]:
    /// https://www.khronos.org/registry/gles/extensions/EXT/texture_compression_s3tc.txt OpenGL & OpenGLES:
    /// [GL_EXT_texture_compression_s3tc][] extension is required \sa <a href =
    /// "https://msdn.microsoft.com/en-us/library/windows/desktop/bb694531(v=vs.85).aspx#BC1">BC1 on MSDN
    ...
    /// D3D counterpart: DXGI_FORMAT_BC2_TYPELESS. OpenGL does not have direct counterpart,
    ...
    /// counterpart: DXGI_FORMAT_BC2_UNORM. OpenGL counterpart: GL_COMPRESSED_RGBA_S3TC_DXT3_EXT. \n
    /// [GL_EXT_texture_compression_s3tc]:
    /// https://www.khronos.org/registry/gles/extensions/EXT/texture_compression_s3tc.txt OpenGL & OpenGLES:
    /// [GL_EXT_texture_compression_s3tc][] extension is required \sa <a href =
    /// "https://msdn.microsoft.com/en-us/library/windows/desktop/bb694531(v=vs.85).aspx#BC2">BC2 on MSDN
    ...
    /// counterpart: DXGI_FORMAT_BC2_UNORM_SRGB. OpenGL counterpart: GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT.
    /// \n [GL_EXT_texture_compression_s3tc]:
    /// https://www.khronos.org/registry/gles/extensions/EXT/texture_compression_s3tc.txt OpenGL & OpenGLES:
    /// [GL_EXT_texture_compression_s3tc][] extension is required \sa <a href =
    /// "https://msdn.microsoft.com/en-us/library/windows/desktop/bb694531(v=vs.85).aspx#BC2">BC2 on MSDN
    ...
    /// Four-component typeless block-compression format with 1:4 compression ratio.\n
    /// D3D counterpart: DXGI_FORMAT_BC3_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_COMPRESSED_RGBA_S3TC_DXT5_EXT is used. \n [GL_EXT_texture_compression_s3tc]:
    /// https://www.khronos.org/registry/gles/extensions/EXT/texture_compression_s3tc.txt OpenGL & OpenGLES:
    /// [GL_EXT_texture_compression_s3tc][] extension is required \sa <a href =
    ...
    /// DXGI_FORMAT_BC3_UNORM. OpenGL counterpart: GL_COMPRESSED_RGBA_S3TC_DXT5_EXT. \n
    /// [GL_EXT_texture_compression_s3tc]:
    /// https://www.khronos.org/registry/gles/extensions/EXT/texture_compression_s3tc.txt OpenGL & OpenGLES:
    /// [GL_EXT_texture_compression_s3tc][] extension is required \sa <a href =
    /// "https://msdn.microsoft.com/en-us/library/windows/desktop/bb694531(v=vs.85).aspx#BC3">BC3 on MSDN
    ...
    /// per 4x4 block (8 bits per pixel) providing 1:4 compression ratio against RGBA8 format. \n D3D
    /// counterpart: DXGI_FORMAT_BC3_UNORM_SRGB. OpenGL counterpart: GL_COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT.
    /// \n [GL_EXT_texture_compression_s3tc]:
    /// https://www.khronos.org/registry/gles/extensions/EXT/texture_compression_s3tc.txt OpenGL & OpenGLES:
    /// [GL_EXT_texture_compression_s3tc][] extension is required \sa <a href =
    /// "https://msdn.microsoft.com/en-us/library/windows/desktop/bb694531(v=vs.85).aspx#BC3">BC3 on MSDN
    ...
    /// D3D counterpart: DXGI_FORMAT_BC4_TYPELESS. OpenGL does not have direct counterpart,
    ...
    /// D3D counterpart: DXGI_FORMAT_BC5_TYPELESS. OpenGL does not have direct counterpart,
    ...
    /// 5 bits for red channel. \n D3D counterpart: DXGI_FORMAT_B5G6R5_UNORM \warning This format is not
    /// available until D3D11.1 and Windows 8. It is also not available in OpenGL
    ...
    /// alpha. \n D3D counterpart: DXGI_FORMAT_B5G5R5A1_UNORM \warning This format is not available until
    /// D3D11.1 and Windows 8. It is also not available in OpenGL
    ...
    /// unused. \n D3D counterpart: DXGI_FORMAT_B8G8R8X8_UNORM. \warning This format is not available in
    /// OpenGL
    TEX_FORMAT_BGRX8_UNORM,

    /// Four-component 32-bit 2.8-biased fixed-point format with 10 bits for each color channel and 2-bit
    /// alpha. \n D3D counterpart: DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM. \warning This format is not
    /// available in OpenGL
    ...
    /// \n D3D counterpart: DXGI_FORMAT_B8G8R8X8_TYPELESS. \warning This format is not available in OpenGL.
    ...
    /// are unused. \n D3D counterpart: DXGI_FORMAT_B8G8R8X8_UNORM_SRGB. \warning This format is not available
    /// in OpenGL.
    TEX_FORMAT_BGRX8_UNORM_SRGB,

    /// Three-component typeless block-compression format. \n
    /// D3D counterpart: DXGI_FORMAT_BC6H_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT is used. \n [GL_ARB_texture_compression_bptc]:
    ...
    /// Three-component typeless block-compression format. \n
    /// D3D counterpart: DXGI_FORMAT_BC7_TYPELESS. OpenGL does not have direct counterpart,
    /// GL_COMPRESSED_RGBA_BPTC_UNORM is used. \n [GL_ARB_texture_compression_bptc]:
    /// https://cvs.khronos.org/svn/repos/ogl/trunk/doc/registry/public/specs/ARB/texture_compression_bptc.txt
    /// OpenGL: [GL_ARB_texture_compression_bptc][] extension is required. Not supported in at least
    /// OpenGLES3.1 \sa <a href =
...
enum TEXTURE_ADDRESS_MODE : uint8_t
{
    ...
    /// Direct3D Counterpart: D3D11_TEXTURE_ADDRESS_WRAP/D3D12_TEXTURE_ADDRESS_MODE_WRAP. OpenGL counterpart:
    /// GL_REPEAT
    TEXTURE_ADDRESS_WRAP = 1,

    /// Flip the texture at every integer junction. \n
    /// Direct3D Counterpart: D3D11_TEXTURE_ADDRESS_MIRROR/D3D12_TEXTURE_ADDRESS_MODE_MIRROR. OpenGL
    ...
    /// Direct3D Counterpart: D3D11_TEXTURE_ADDRESS_CLAMP/D3D12_TEXTURE_ADDRESS_MODE_CLAMP. OpenGL
    ...
    /// Direct3D Counterpart: D3D11_TEXTURE_ADDRESS_BORDER/D3D12_TEXTURE_ADDRESS_MODE_BORDER. OpenGL
    ...
    /// the maximum value. \n
    /// Direct3D Counterpart: D3D11_TEXTURE_ADDRESS_MIRROR_ONCE/D3D12_TEXTURE_ADDRESS_MODE_MIRROR_ONCE. OpenGL
    /// counterpart: GL_MIRROR_CLAMP_TO_EDGE \note GL_MIRROR_CLAMP_TO_EDGE is only available in OpenGL4.4+,
    /// and is not available until at least OpenGLES3.1
...
enum COMPARISON_FUNCTION : uint8_t
{
    ...
    /// Direct3D counterpart: D3D11_COMPARISON_NEVER/D3D12_COMPARISON_FUNC_NEVER. OpenGL counterpart:
    /// GL_NEVER.
    ...
    /// Direct3D counterpart: D3D11_COMPARISON_EQUAL/D3D12_COMPARISON_FUNC_EQUAL. OpenGL counterpart:
    /// GL_EQUAL.
    COMPARISON_FUNC_EQUAL,

    /// Comparison passes if the source data is less than or equal to the destination data.\n
    /// Direct3D counterpart: D3D11_COMPARISON_LESS_EQUAL/D3D12_COMPARISON_FUNC_LESS_EQUAL. OpenGL
    /// counterpart: GL_LEQUAL.
    COMPARISON_FUNC_LESS_EQUAL,

    /// Comparison passes if the source data is greater than the destination data.\n
    /// Direct3D counterpart: 3D11_COMPARISON_GREATER/D3D12_COMPARISON_FUNC_GREATER. OpenGL counterpart:
    /// GL_GREATER.
    COMPARISON_FUNC_GREATER,

    /// Comparison passes if the source data is not equal to the destination data.\n
    /// Direct3D counterpart: D3D11_COMPARISON_NOT_EQUAL/D3D12_COMPARISON_FUNC_NOT_EQUAL. OpenGL counterpart:
    /// GL_NOTEQUAL.
    COMPARISON_FUNC_NOT_EQUAL,

    /// Comparison passes if the source data is greater than or equal to the destination data.\n
    /// Direct3D counterpart: D3D11_COMPARISON_GREATER_EQUAL/D3D12_COMPARISON_FUNC_GREATER_EQUAL. OpenGL
    /// counterpart: GL_GEQUAL.
    COMPARISON_FUNC_GREATER_EQUAL,

    /// Comparison always passes. \n
    /// Direct3D counterpart: D3D11_COMPARISON_ALWAYS/D3D12_COMPARISON_FUNC_ALWAYS. OpenGL counterpart:
    /// GL_ALWAYS.
...
struct SwapChainDesc
{
    ...
    SwapChainDesc(uint32_t _Width, uint32_t _Height, TEXTURE_FORMAT _ColorBufferFormat,
                  TEXTURE_FORMAT _DepthBufferFormat, uint32_t _SamplesCount = SwapChainDesc{}.SamplesCount,
                  uint32_t _BufferCount         = SwapChainDesc{}.BufferCount,
                  float    _DefaultDepthValue   = SwapChainDesc{}.DefaultDepthValue,
                  uint8_t  _DefaultStencilValue = SwapChainDesc{}.DefaultStencilValue) :
        Width(_Width),
        Height(_Height),
...
struct TextureFormatAttribs
{
    ...
    TextureFormatAttribs(const char * _Name, TEXTURE_FORMAT _Format, uint8_t _ComponentSize,
                         uint8_t _NumComponents, COMPONENT_TYPE _ComponentType, bool _IsTypeless,
                         uint8_t _BlockWidth, uint8_t _BlockHeight) noexcept :
        Name(_Name),
        Format(_Format),
...
{
    static constexpr const uint32_t RemainingMipLevels   = static_cast<uint32_t>(-1);
    static constexpr const uint32_t RemainingArraySlices = static_cast<uint32_t>(-1);
    ...
    uint32_t MipLevelsCount = RemainingMipLevels;
    ...
    uint32_t ArraySliceCount = RemainingArraySlices;
    ...
    StateTransitionDesc(ITexture * _pTexture, RESOURCE_STATE _OldState, RESOURCE_STATE _NewState,
                        uint32_t _FirstMipLevel = 0, uint32_t _MipLevelsCount = RemainingMipLevels,
                        uint32_t _FirstArraySlice = 0, uint32_t _ArraySliceCount = RemainingArraySlices,
    ...
    StateTransitionDesc(ITexture * _pTexture, RESOURCE_STATE _OldState, RESOURCE_STATE _NewState,
        ...
        StateTransitionDesc(_pTexture, _OldState, _NewState, 0, RemainingMipLevels, 0, RemainingArraySlices,
                            STATE_TRANSITION_TYPE_IMMEDIATE, _UpdateState)
    {}

    StateTransitionDesc(IBuffer * _pBuffer, RESOURCE_STATE _OldState, RESOURCE_STATE _NewState,
                        bool _UpdateState) noexcept :
        pBuffer(_pBuffer), OldState(_OldState), NewState(_NewState), UpdateResourceState(_UpdateState)
    {}
};
}   // namespace evnt
